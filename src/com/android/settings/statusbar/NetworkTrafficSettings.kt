...
class NetworkTrafficSettings : SettingsPreferenceFragment(), Preference.OnPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enabledPref.isChecked = Settings.System.getInt(
            resolver, Settings.System.NETWORK_TRAFFIC_ENABLED, 0
        ) == 1
        enabledPref.onPreferenceChangeListener = this

        modePref = findPreference(KEY_MODE)!!
        val mode = Settings.System.getInt(
            resolver, Settings.System.NETWORK_TRAFFIC_MODE, 0
        )
        ...
        autohidePref.isChecked = Settings.System.getInt(
            resolver, Settings.System.NETWORK_TRAFFIC_AUTOHIDE, 0
        ) == 1
        autohidePref.onPreferenceChangeListener = this

        unitsPref = findPreference(KEY_UNITS)!!
        val units = Settings.System.getInt(
            resolver, Settings.System.NETWORK_TRAFFIC_UNITS, 1
        )
        ...
        val interval = Settings.System.getInt(
            resolver, Settings.System.NETWORK_TRAFFIC_REFRESH_INTERVAL, 2
        )
        ...
        hideArrowPref.isChecked = Settings.System.getInt(
            resolver, Settings.System.NETWORK_TRAFFIC_HIDEARROW, 0
        ) == 1
        ...
        return when (preference) {
            enabledPref -> {
                ...
                Settings.System.putInt(
                    resolver, Settings.System.NETWORK_TRAFFIC_ENABLED, if (enabled) 1 else 0
                )
            ...
            modePref -> {
                ...
                Settings.System.putInt(
                    resolver, Settings.System.NETWORK_TRAFFIC_MODE, mode
                )
            ...
            autohidePref -> {
                ...
                Settings.System.putInt(
                    resolver, Settings.System.NETWORK_TRAFFIC_AUTOHIDE, if (autohide) 1 else 0
                )
                true
            }
            unitsPref -> {
                ...
                Settings.System.putInt(
                    resolver, Settings.System.NETWORK_TRAFFIC_UNITS, units
                )
            ...
            refreshIntervalPref -> {
                ...
                Settings.System.putInt(
                    resolver, Settings.System.NETWORK_TRAFFIC_REFRESH_INTERVAL, interval
                )
            ...
            hideArrowPref -> {
                ...
                Settings.System.putInt(
                    resolver, Settings.System.NETWORK_TRAFFIC_HIDEARROW, if (hideArrow) 1 else 0
                )
                true
            }
            else -> false
