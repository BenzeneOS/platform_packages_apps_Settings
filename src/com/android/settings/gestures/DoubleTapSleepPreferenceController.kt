...
class DoubleTapSleepPreferenceController(context: Context, key: String) :
    ...
    override fun isChecked(): Boolean {
        ...
        val statusBar = Settings.System.getInt(
            mContext.contentResolver,
            Settings.System.DOUBLE_TAP_SLEEP_STATUS_BAR,
            0
        )
        val lockscreen = Settings.System.getInt(
            mContext.contentResolver,
    ...
    override fun setChecked(isChecked: Boolean): Boolean {
        ...
        val statusBarResult = Settings.System.putInt(
            mContext.contentResolver,
            Settings.System.DOUBLE_TAP_SLEEP_STATUS_BAR,
            value
        )
        val lockscreenResult = Settings.System.putInt(
            mContext.contentResolver,
            Settings.System.DOUBLE_TAP_SLEEP_LOCKSCREEN,
            value
        )
