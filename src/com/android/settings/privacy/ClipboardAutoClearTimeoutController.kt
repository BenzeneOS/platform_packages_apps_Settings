...
class ClipboardAutoClearTimeoutController(
    context: Context,
    key: String
) : BasePreferenceController(context, key), Preference.OnPreferenceChangeListener {

    override fun getAvailabilityStatus(): Int =
        if (Settings.Global.getInt(mContext.contentResolver,
    ...
    override fun updateState(preference: Preference) {
        ...
        val value = ExtSettings.CLIPBOARD_AUTO_CLEAR_TIMEOUT.get(mContext)
    ...
    override fun onPreferenceChange(preference: Preference, newValue: Any): Boolean {
        ...
        ExtSettings.CLIPBOARD_AUTO_CLEAR_TIMEOUT.put(mContext, value)
        val listPreference = preference as ListPreference
