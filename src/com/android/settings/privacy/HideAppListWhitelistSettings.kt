...
/**
 * Fragment for managing the whitelist of apps that can see all installed apps.
 */
class HideAppListWhitelistSettings : InstrumentedFragment(), SearchView.OnQueryTextListener {
    ...
    // Apps that should not appear in the whitelist UI (they're already exempted)
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        menu.clear()
        inflater.inflate(R.menu.hide_applist_whitelist_menu, menu)
    ...
    private fun loadApps() {
        ...
        loadJob = CoroutineScope(Dispatchers.IO).launch {
            // Load whitelisted apps from settings
            val whitelistStr = Settings.Secure.getString(
                requireContext().contentResolver,
                Settings.Secure.HIDE_APPLIST_WHITELIST
            ) ?: ""
            whitelistedApps = whitelistStr.split(",")
            ...
            allApps = packages
                ...
                .map { pkg ->
                    AppInfo(
                        ...
                        isWhitelisted = whitelistedApps.contains(pkg.packageName)
                    )
                }
    ...
    private fun toggleApp(app: AppInfo) {
        ...
        val newValue = whitelistedApps.joinToString(",")
        for (user in users) {
    ...
    inner class AppListAdapter : RecyclerView.Adapter<AppListAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.checkbox.isChecked = app.isWhitelisted
